...
%type <node> program function compound_stmt decl_list decl ident_list stmt_list stmt expr assignment equality relational additive multiplicative primary
...
decl_list:
      decl_list decl { $$ = linkSibling($1, $2); }
    | /* empty */ { $$ = NULL; }
;
...
stmt_list:
      stmt_list stmt { $$ = linkSibling($1, $2); }
    | /* empty */ { $$ = NULL; }
;
